...
Group.new('LspDiagnosticsVirtualTextWarning',     c.mono_2,   c.none,  no)
...
Group.new('TSField',              c.mono_1, c.none, no)
...
Group.new('TSInclude',            c.hue_6, c.none, no)
Group.new('TSKeyword',            c.hue_5, c.none, no)
Group.new('TSKeywordFunction',    c.hue_5, c.none, no)
Group.new('TSKeywordOperator',    c.hue_6, c.none, no)
Group.new('TSLabel',              c.hue_2, c.none, no)
Group.new('TSLiteral',            c.hue_6_2, c.none, no)
Group.new('TSMethod',             c.hue_2, c.none, no)
Group.new('TSNamespace',          c.hue_2, c.none, no)
Group.new('TSNumber',             c.hue_6, c.none, no)
Group.new('TSOperator',           c.mono_1, c.none, no)
Group.new('TSParameter',          c.mono_1, c.none, no)
...
Group.new('TSType',               c.hue_1, c.none, no)
